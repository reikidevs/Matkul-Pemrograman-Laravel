...
<head>
    ...
    <title>{{ $master['title'] ?? 'Dashboard' }} - KostKu</title>
    <!-- Favicon icon -->
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a href="{{ route('kamar.index') }}" aria-expanded="false">
                            <i class="icon-home menu-icon"></i><span class="nav-text">Kelola Kamar</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('penghuni.index') }}" aria-expanded="false">
                            <i class="icon-people menu-icon"></i><span class="nav-text">Kelola Penghuni</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('pembayaran.index') }}" aria-expanded="false">
                            <i class="icon-wallet menu-icon"></i><span class="nav-text">Kelola Pembayaran</span>
                        </a>
                    </li>
                    @endif
                    ...
                    <li>
                        <a href="{{ route('komplain.index') }}" aria-expanded="false">
                            <i class="icon-speech menu-icon"></i><span class="nav-text">Komplain</span>
                        </a>
                    </li>
                </ul>
            </div>
