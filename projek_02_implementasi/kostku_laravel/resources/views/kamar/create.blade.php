...
@section('title', 'Tambah Kamar - KostKu')

@section('content')
<!-- Page Header -->
<div style="margin-bottom: 24px;">
    <h2 class="page-title">Tambah Kamar Baru</h2>
    <p style="color: var(--gray-500); margin-top: 4px;">Lengkapi formulir di bawah untuk menambahkan kamar baru</p>
</div>
    ...
    <form action="{{ route('kamar.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <textarea id="fasilitas" name="fasilitas" rows="4" 
                placeholder="Contoh: AC, Kasur, Lemari, Kamar Mandi Dalam, WiFi">{{ old('fasilitas') }}</textarea>
            @error('fasilitas')
                <div class="form-error">{{ $message }}</div>
            @enderror
