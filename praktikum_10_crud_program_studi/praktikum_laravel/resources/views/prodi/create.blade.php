                ...
                <form action="{{ route('prodi.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="kode_prodi" id="kode_prodi"
                            ...
                            value="{{ old('kode_prodi') }}" placeholder="Contoh: TI, SI, MNJ">
                        @error('kode_prodi')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_prodi" id="nama_prodi"
                            ...
                            value="{{ old('nama_prodi') }}" placeholder="Contoh: Teknik Informatika">
                        @error('nama_prodi')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="fakultas" id="fakultas"
                            ...
                            value="{{ old('fakultas') }}" placeholder="Contoh: Fakultas Teknologi Informasi dan Komunikasi">
                        @error('fakultas')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
